...
INSERT INTO `lab_applications` (`id`, `app_id`, `applicant_name`, `applicant_email_id`, `applicant_mobile_no`, `applicant_alternate_no`, `applicant_address`, `applicant_nationality`, `technical_qualification`, `un_reg_medical_practice`, `lab_name`, `contact_person`, `contact_no`, `lab_address`, `floor_space`, `check_up_details`, `floor_space_kitchen`, `sanitary_details`, `storage_details`, `others`, `maternity_beds`, `patient_beds`, `alien_name`, `alien_details`, `ownership_agreement`, `tax_receipt`, `doc_certificate`, `reg_certificate`, `staff_certificate`, `nursing_staff_deg_certificate`, `nursing_staff_reg_certificate`, `bio_des_certificate`, `society_noc`, `fire_noc`, `status`, `is_deleted`, `created_at`, `updated_at`, `application_date`, `situation_registration`, `name_of_nursinghome`, `address_of_nursinghome`, `arrng_immunization_of_the_employees`, `sanitary_conveniences_for_emp`, `food_arrangements`, `fee_charges`, `other_business`, `other_business_details`, `certificate_expirydate`, `user_id`, `application_type`, `health_officer`) VALUES
(1, 51, 'Sonali pathak', 'sonalipathak@yopmail.com', '7896541235', '7896541235', 'Consectetur aperiam', 'Consequatur', 'QWE', 1, 'Brenda Kirkland', 'Beatae est alias inv', '7896541235', 'Obcaecati mollitia e', 'Quo occaecat fuga D', 'Velit recusandae A', '', 'Non dolor ex sunt fu', '', 'Quis autem expedita ', '82', '60', 'Kadeem Garrett', 'Voluptas nisi nostru', 248, 249, 250, 0, 0, 0, 0, 0, 0, 0, 85, 0, '2020-11-26 12:32:07', '2020-11-26 12:52:19', '2020-11-27', 'Tempore omnis volup', 'Holly Rivera', 'MacKenzie Warner', 'Qui dolores accusamu', 'Vero in exercitation', '', 'Pariatur Nesciunt ', NULL, NULL, NULL, 23, 1, 3);
