<?php 
	class Lab_applications_table extends CI_Model {
	    ...
	    var $column_order = array(null,'applicant_name','applicant_email_id','applicant_mobile_no','applicant_address','applicant_qualification','lab_name','lab_address','contact_no','contact_person',null,null,null,null);

		//set column field database for datatable searchable 
	    var $column_search = array('applicant_name','applicant_email_id','applicant_mobile_no','applicant_address','applicant_qualification','lab_name','lab_address','contact_no','contact_person');
