...
class Auth
{
     ...
     */
    public function login($login, $password, $remember = false, $company_id, $branch_id)
    {
    ...
    public function user()
    {
        ...
        if (! $this->ci->session->userdata('identity')
			...
			|| ! $this->ci->session->userdata('company_id')
			|| ! $this->ci->session->userdata('branch_id')
        ) {
            return false;
        }
     ...
     * @return void
     */
    protected function clear_login_attempts($login, $expires = 300)
    {
	...
	public function company_id()
    {
        ...
        return $this->ci->session->userdata('company_id');
    }
