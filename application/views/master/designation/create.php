                        ...
                        <div class="col-4">
                          <div class="form-group">
                            <label for="design_title">Designation Title<span class="red">*</span></label>
                              <input type="hidden" class="form-control" value="" name="design_id" id="design_id">
                             <input type="text" class="form-control" id="design_title" name ="design_title" placeholder="Enter the road title">
                          </div>
                        </div>                        
                      </div>
                    </div>
