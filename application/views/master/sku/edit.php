                      ...
                      <div class="row">
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <select class="selectpicker form-control" id="dept_id" name="dept_id" data-live-search="true" readonly>
                              <option value="">--- Select Department ---</option>
                              <option value="<?= $sku['dept_id']?>" selected><?= $sku['dept_title']?></option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            <label for="sku_title">Sku Title<span class="red">*</span></label>
                              <input type="hidden" class="form-control" value="<?=$sku['sku_id']?>" name="sku_id" id="sku_id">
                             <input type="text" class="form-control" id="sku_title" name ="sku_title" value="<?=$sku['sku_title']?>" placeholder="Enter the Sku title">
                          </div>
                        </div> 
                      </div>
                    </div>
