                         ...
                         <div class="col-4">
                          <div class="form-group">
                            <label for="sku_title">Unit Value<span class="red">*</span></label>
                              <input type="hidden" class="form-control" value="<?=($unit['unit_id']) ? $unit['unit_id'] : ''?>" name="unit_id" id="unit_id">
                             <input type="text" class="form-control" id="unit_value" name ="unit_value" placeholder="Enter value" value="<?=($unit['unit_value']) ? $unit['unit_value'] : ''?>">
                          </div>
                        </div> 
                        <div class="col-4">
                          <div class="form-group">
                            <label for="sku_title">Unit Label<span class="red">*</span></label>
                            <input type="text" class="form-control" id="unit_label" name ="unit_label" placeholder="Enter label" value="<?=($unit['unit_label']) ? $unit['unit_label'] : ''?>">
                          </div>
                        </div>
                        <!-- <div class="col-4">
                          <div class="form-group">
                            <label for="sku_title">Unit Cost<span class="red">*</span></label>
                            <input type="text" class="form-control" id="unit_cost" name ="unit_cost" placeholder="Enter Cost" value="<?=($unit['unit_cost']) ? $unit['unit_cost'] : ''?>">
                          </div>
                        </div> --> 
                      </div>
                    </div>
