                        ...
                        <div class="col-4">
                          <div class="form-group">
                            <label for="applicant_name">Qualification Title<span class="red">*</span></label>
                              <input type="hidden" class="form-control" value="" name="qual_id" id="qual_id">
                             <input type="text" class="form-control" id="qual_title" name ="qual_title" placeholder="Enter the qual title">
                          </div>
                        </div>                        
                      </div>
                    </div>
