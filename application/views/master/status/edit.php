                      ...
                      <div class="row">
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" value="<?=($status['status_id']) ? $status['status_id']: '' ?>" name="status_id" id="status_id" placeholder="Enter full name">
                            <input type="text" class="form-control" value="<?=($status['status_title']) ? $status['status_title']: '' ?>"  name="status_title" id="status_title" placeholder="Enter full name">
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <select class="selectpicker form-control" id="dept_id" name="dept_id" data-live-search="true">
                              ...
                              <?php
                                foreach ($department as $key => $dept) {
                                  if($status['dept_id'] == $dept['dept_id']) {
