        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p>Approval Pending Till Today</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p>Todays Total Amount Collected</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?= $data['yearlyAmount']; ?></h3>

                <p>Amount Needs Tobe Collected</p>
              </div>
              <div class="icon">
            ...
            <div class="card">
              <div class="card-header border-0">
                <h3 class="card-title">
                  ...
                  Monthly Request Approved and UnApproved
                </h3>
              </div>
              <div class = "card-body">
                <center>
      ...
      datasets: [
        {
          ...
          data: <?= json_encode($data['ApprovedUnApproved']['approvedArray']); ?>
        },
        {
          label: "UnApproved",
          backgroundColor: "#8e5ea2",
          data: <?= json_encode($data['ApprovedUnApproved']['unapprovedArray']); ?>
        }
      ]
    },
    options: {
