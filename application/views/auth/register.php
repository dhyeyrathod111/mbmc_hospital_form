...
<div class="register-box">
  <div class="register-logo">
    <a href="javascript:void(0)"><b>MBMC</b>&nbsp;User Registration</a>
  </div>
...
<script src="<?php echo base_url()?>assets/custom/js/custom.js" id = "usersPage" is_type = "register"></script>
</body>
</html>
