    ...
    <div class = "A4">
        ...
        <div class="row">
            ...
            <div class="col-3 text-center">
                <?php if (!empty($appimages->user_image)) : ?>
                    <img style="width: 100%;height: auto;" src="<?= base_url('uploads/lab/'.$appimages->user_image->image_enc_name) ?>">
                <?php else : ?>
        ...
        <div class="row">
            <div class="col-12 text-justify">
                <p>मीराभाईंदर महानगरपालिका क्षेत्रात <?= $application->applicant_address ?> या नावाने <?= $application->lab_name ?> या ठिकाणी डा. <?= $application->applicant_name ?> यांनी व्यवसाय चालविण्यास खालील अटी-शर्तीचा अधीन राहून दि.  <?= date("d-m-Y", strtotime('+ 3 year', strtotime($finalApprovelDate->created_at))) ?>  या कालावधीपर्यंत परवाना देण्यात येते आहे.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center">
