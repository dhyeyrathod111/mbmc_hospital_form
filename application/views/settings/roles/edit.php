                      ...
                      <div class="row">
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" value="<?=($role['role_id']) ? $role['role_id']: '' ?>" name="role_id" id="role_id">

                            <input type="text" class="form-control" value="<?=($role['role_title']) ? $role['role_title']: '' ?>"  name="role_title" id="role_title" placeholder="Enter role title">
