    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="extention_form" action="<?= base_url('pwd/extention_process') ?>">
                <div class="modal-body extention_form_body">
	...
	$(function(){
		...
		let userPwd_table = $("#userPwd_table").DataTable({
			...
			initComplete:settings => {
				...
				$('.file_close_class').each((index , oneFields , Event)=>{
					oneFields.parentElement.parentElement.style = "background-color: #7fff00;"
				});
			},
