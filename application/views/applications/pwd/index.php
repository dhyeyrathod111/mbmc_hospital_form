                      ...
                      <div class="col-12">
                        <div class="row">
                          ...
                          <div class = "col-3">
                            ...
                            <select name="permission_type" class="form-control" id="permission_type_selecter">
                              <option value="">---Select Permission Type---</option>
                              <?php foreach ($permission_type as $onepermission) : ?>
                                <option value="<?= $onepermission->pt_id ?>"><?= $onepermission->permission_type ?></option>
                              <?php endforeach; ?>
                            </select>
                          </div>
                          ...
                          <div class = "col-3">
                            ...
                            <select name="approval_status" class = "form-control" id = "approval_status">
                              ...
                              <option value="4">Closed File</option>
                            </select>
                          </div>
                        </div>
                      </div>
  ...
  <!-- /.content-wrapper -->
	...
	<div class="modal fade" id="extention_approvel_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" data-backdrop="static" data-keyboard="false" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">                
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Extention Request</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body ext_approvel_body">
    ...
    <div class="modal fade" id="file_close_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document" style="width: 50%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('pwd/close_application_process') ?>" id="close_application_form">
...
<script src="<?php echo base_url()?>/assets/table2csv/src/table2csv.js"></script>
<!-- page script -->
<script>
  $(function () {

    $('#payment_type').selectpicker("destroy");
    $('#payment_status').selectpicker("destroy");
    ...
    pwd_table = $('#pwd_table').DataTable({
      ...
      "ajax": {
          ...
          data: function(d){
            ...
            d.permission_type = $(document).find("#permission_type_selecter").val()
          }
      },
    ...
    $(document).on('change', "#permission_type_selecter", function(){
      pwd_table.draw();
    });
