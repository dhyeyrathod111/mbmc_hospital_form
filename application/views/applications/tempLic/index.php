  ...
  <div class="content-wrapper">  
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Temporary license Section</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Temporary license Section</li>
            </ol>
          </div>
        </div>
      </div>
 	...
 	<section class = "content">
 		<div class="row">
            ...
            <!-- <h3 class="card-title"><strong>Temporary Licence Section</strong></h3> -->
          </div>
          ...
          <div class="card-body table-wrapper-scroll-y my-custom-scrollbar">
            <div class = "card">
          	...
          	<table id="licApp_table" class="table table-bordered table-hover" style = "width: 100%">
          		<thead>
  ...
  <!-- End For remarks -->
    ...
    <div class="modal fade" id="modal-renewal">
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
            <h4 class="modal-title">Renew License Date</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
           </div>
          <form id = "renewalForm" method="post" accept-charset="utf-8">
                     ...
                     <div class="row">  
                       ...
                       <div class = "col-3">
                        <div class="form-group">
                          <label for="road_type">Renewal Date<span class="red">*</span></label>
                          <input type="hidden" name="lic_id" id = "lic_id">
                          <input type="text" name="renewal_dateEdit" class = "form-control datepicker" id = "renewal_dateEdit">
                        </div>    
                       </div>
                       <div class = "col-3">
                        <div class="form-group">
                          <label for="road_type">Expiry Date<span class="red">*</span></label>
                          <input type="text" name="expiry_dateEdit" class = "form-control" id = "expiry_dateEdit" readonly="">
                        </div>    
                       </div>
                       <div class = "col-3"></div>
                    </div>  
...
$(function () {
  var datatable = $('#licApp_table').DataTable({
    "processing": true,
    "serverSide": true,
    "searchable": true,
    'serverMethod': 'post',
