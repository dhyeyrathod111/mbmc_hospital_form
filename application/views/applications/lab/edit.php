            ...
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <h3 class="text-center mt-1">
                        <label for="email_id" class="text-info">Application Form for License to run Dispensary/ lab /Day Care Center /Path. Lab./ X-ray Center/ Physiotherapy Center, etc. Under section 386 of Maharashtra Municipal Corporation Act, 1949.</label>
                    </h3>
                    <hr />
                    ...
                    <form role="form" class="lab-form" id="lab-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="applicant_name">Name lab<span class="red">*</span></label>
                                        <i class="fas fa-info-circle" title="Full name of the Dispensary/ lab"></i>
                                        <input type="text" class="form-control" value="<?= $application->lab_name ?>" name="lab_name" id="lab_name" placeholder="Enter Name of the Dispensary/ lab">
                                    </div>  
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="applicant_name">Telephone No of lab<span class="red">*</span></label>
                                        <i class="fas fa-info-circle" title="Full name of the Dispensary/ lab"></i>
                                        <input type="text" class="form-control" value="<?= $application->lab_telephone_no ?>" name="lab_telephone_no" id="lab_telephone_no" placeholder="Enter Telephone No">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="5" class="form-control" name="lab_address" id="lab_address" placeholder="Enter Address"><?= $application->lab_address ?></textarea> 
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <table class="table staff_grid">
                                        ...
                                        <tbody class="tableBody">
                                            <?php foreach ($lab_staff as $oneStaff) : ?>
                                                <tr id="oneStaffField">
                                                    <td>
                                                        <input class="form-control" value="<?= $oneStaff->sr_number_lab_Staff ?>" type="number" id="sr_number_lab_Staff" name="sr_number_lab_Staff[]" multiple>
                                                    </td>
                                                    <td>
                                                        <input class="form-control" value="<?= $oneStaff->name_lab_Staff ?>" type="text" id="name_lab_Staff" name="name_lab_Staff[]" multiple>
                                                    </td>
                                                    <td>
                                                        <select class="form-control" name="designation_lab_Staff[]" id="designation_lab_Staff">
                                                            <option value="">---Select designation---</option>
                                                            <?php foreach ($designation as $desig) : ?>
                                                                <option <?= ($oneStaff->designation_lab_Staff == $desig['design_id']) ? 'selected' : ''  ?> value="<?= $desig['design_id'] ?>"><?= $desig['design_title'] ?></option>
                                                            <?php endforeach ; ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select class="form-control" name="qualification_lab_Staff[]" id="qualification_lab_Staff">
                                                            ...
                                                            <?php foreach ($qualification as $quali) : ?>
                                                                <option <?= ($oneStaff->qualification_lab_Staff == $quali['qual_id']) ? 'selected' : '' ;  ?> value="<?= $quali['qual_id'] ?>"><?= $quali['qual_title'] ?></option>
                                                            <?php endforeach ; ?>
                                                        </select>
                                                    </td>
                                ...
                                <div class="col-6">
                                    ...
                                    <?php if (!empty($appimages->ownership_agreement)) : ?>
                                        <h3 class="card-title link-margin">
                                            <a target="_blank" href="<?= base_url('uploads/lab/'.$appimages->ownership_agreement->image_enc_name) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6" style="">
                                    ...
                                    <?php if (!empty($appimages->tax_receipt)) : ?>
                                        <h3 class="card-title link-margin">
                                            <a target="_blank" href="<?= base_url('uploads/lab/'.$appimages->tax_receipt->image_enc_name) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6" style="">
                                    <?php if (!empty($appimages->doc_certificate)) : ?>
                                        <h3 class="card-title link-margin">
                                            <a target="_blank" href="<?= base_url('uploads/lab/'.$appimages->doc_certificate->image_enc_name) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6" style="">
                                    ...
                                    <?php if (!empty($appimages->bio_medical_certificate)) : ?>
                                        <h3 class="card-title link-margin">
                                            <a target="_blank" href="<?= base_url('uploads/lab/'.$appimages->bio_medical_certificate->image_enc_name) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6" style="">
                                    <?php if (!empty($appimages->aadhaar_card)) : ?>
                                        <h3 class="card-title link-margin">
                                            <a target="_blank" href="<?= base_url('uploads/lab/'.$appimages->aadhaar_card->image_enc_name) ?>">
