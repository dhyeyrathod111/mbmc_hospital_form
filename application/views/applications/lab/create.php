                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="application_date" id="application_date_lab" placeholder="Application date">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="lab_address" id="applicant_address" placeholder="Enter lab address"></textarea> 
                                    </div>
                                </div>
                            </div>
                        </div>
