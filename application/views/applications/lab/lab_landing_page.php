        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    <form role="form" action="<?= base_url('lab/application_type_process') ?>" method="post">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-success float-right" href="<?= base_url('lab/user_apps_list') ?>">Application List</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
