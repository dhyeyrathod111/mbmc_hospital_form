...
<body>
    <div class = "A4">
        ...
        <div class="col-12 text-center"> 
            <p>After having inspected of <?= $application->clinic_name ?> located at <?= $application->clinic_address ?> the finding on inspection are.</p>
        </div>
        <br />
        <div class="col-12"> 
            <ul>
                ...
                <?php if ($inspection->noc_from_society != 0) : ?>
                    <li>NOC from society for clinic/nursing home.</li>
                <?php endif ; ?>
