                  ...
                  <form role="form" class="clinic-form" id="clinic-form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" value="" name="clinic_address" id="applicant_address" placeholder="Enter clinic address">
                              <?=($users['clinic_address'] != null) ? $users['clinic_address'] :'' ?>
                            </textarea> 
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card-footer">
                       <div class="row justify-content-center">
                            ...
                            <a href="<?= base_url()?>clinic" class="btn btn-lg btn-info white">Cancel</a>&nbsp&nbsp&nbsp
