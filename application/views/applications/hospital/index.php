...
<div class="modal fade" id="inspection_form_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="inspection_form" action="<?= base_url('hospital/inspection_form_process') ?>">
...
<div class="modal fade" id="payment_request_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="payment_request_form" action="<?= base_url('hospital/payment_request_process') ?>">
...
<div class="modal fade" id="payment_approvel_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="payment_approvel_form" action="<?= base_url('hospital/payment_approvel_process') ?>">
...
<script type="text/javascript" src="<?php echo base_url()?>/assets/custom/js/hospital.js" id = "createHospital" is_user = "<?= $this->authorised_user['user_id'] ?>"></script>
<!-- page script -->
<script>
    $(function () {
      hospital_table = $('#hospital_table').DataTable({
        ...
        "ajax": {
          url: "<?php echo base_url('hospital/getlist'); ?>",
          type: "POST",
          data: function(d){
