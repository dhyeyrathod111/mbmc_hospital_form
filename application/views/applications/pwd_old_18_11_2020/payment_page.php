        ...
        <div class="login-box" style="width: 60%">
            <div class="card">
                ...
                <div class="card-body login-card-body">
                    ...
                    <form id="payment_from" action="<?php echo base_url('user_authentication/process_payment') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <input value="<?= $pay_amount[0]['grand_total']; ?>" readonly type="text" class="form-control" name="payment_amount">
                        </div>
