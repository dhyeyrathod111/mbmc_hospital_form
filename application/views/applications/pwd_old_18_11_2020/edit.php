                          ...
                          <div class="row">
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <textarea class="form-control" name="road_name" id="road_name" placeholder="Enter name of road"><?= $users['road_name'] ?></textarea>
                              </div>
                            </div>
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $users['landmark'] ?>" name="landmark" id="landmark" placeholder="Enter Landmark"></input>
                              </div>
                            </div>
                    ...
                    <div class="card-footer">
                      <div class="row center">
                         <div class="col-12">
														...
														?>
                            <?php if ( ($users['last_approved_role_id'] <= $this->authorised_user['role_id']) ) : ?>
