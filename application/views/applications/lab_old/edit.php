                  ...
                  <form role="form" class="clinic-form" id="clinic-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-4">
                          <div class="form-group">
                            <label for="lab_name">Lab Name<span class="red">*</span></label>
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?=($users['contact_no'] != null) ? $users['contact_no'] :'' ?>" name="contact_no" id="contact_no" placeholder="Enter contact no.">
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="form-group">
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            <label for="clinic_address">Lab Address<span class="red">*</span></label>
                            <textarea type="text" class="form-control" value="" name="lab_address" id="lab_address" placeholder="Enter lab address">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-4">
                          <div class="icheck-primary">
                            <input type="checkbox" name="immunization" id="immunization" value="<?=($users['immunization'] != null) ? $users['immunization'] :'0' ?>"
                             <?= ($users['immunization'] == '1' ? 'checked' : '') ?>>
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?=($users['immunization_details'] != null) ? $users['immunization_details'] :'' ?>" name="immunization_details" id="immunization_details" placeholder="Enter immunization details">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-4">
                          <div class="icheck-primary">
                            <input type="checkbox" value="1" name="bio_waste" id="bio_waste" value="<?=($users['bio_waste'] != null) ? $users['bio_waste'] :'0' ?>"
                             <?= ($users['bio_waste'] == '1' ? 'checked' : '') ?>>
                            <label for="bio_waste">
                              Bio-waste
                            </label>
                          </div>
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" value="<?=($users['bio_waste_valid'] != null) ? $users['bio_waste_valid'] :'' ?>" name="bio_waste_valid" id="bio_waste_valid" placeholder="Enter Bio waste validity">
                          </div>
                        </div>
                      </div>
                    </div>
