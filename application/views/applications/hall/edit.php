                  ...
                  <form role="form" class="hall-form" id="hall-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="row">
                            ...
                            <select class="selectpicker form-control" id="sku_price_id" name="sku_price_id" data-live-search="true">
                              ...
                              <?php 
                                foreach ($sku_price as $key => $val) {
                                  if($users['sku_price_id'] == $val['price_id']) {
                                    $select = 'selected="selected"';
                                  } else {
                                    $select = '';
                                  }
                                  echo '<option value="'.$val['price_id'].'" '.$select.'>'.$val['sku_title'].'</option>';
                                }
                              ?>
                            </select>
                          </div>
                        ...
                        <div class="col-4">
                          <div class="form-group">
                            <label for="dol">Security Deposit<span class="red">*</span></label>
                            <input type="text" class="form-control" value="<?=($users['amount'] != null) ? $users['amount'] :'' ?>" name="amount" id="amount" placeholder="Enter Amount">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="custom-file">
                                <input type="file" name="address_proof" id="address_proof" value="" class="custom-file-input">

                                 <input type="hidden" name="address_proof_name" id="address_proof_name_id" value="<?= $users['address_proof_name']?>" class="custom-file-input">
                        ...
                        <div class="col-6" style="">
                          <h3 class="card-title link-margin">
                            <label for="" id="address_proof_name"  class="text-info"><a href="<?=($users['address_proof'] != null) ? $users['address_proof'] :'' ?>"><?= $users['address_proof_name']?></a>
                            </label>
                          </h3>
                        </div>
                      </div>
