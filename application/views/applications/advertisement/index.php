        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Advertisement Section</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class = "col-md-12">
          <div class = "card">
            <div class="card-header">
              <h3 class="card-title"><strong>Advertisement Section</strong></h3>
            </div>
            ...
            <div class="card-body table-wrapper-scroll-y my-custom-scrollbar">
              <div class = "card">
                <div class = "card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <br>
                      <a type="button" href="<?=base_url()?>advertisement/create" class="add-btn btn btn-block btn-info">Add</a>
                    </div>
                  </div>
              ...
              <table id="advertisement_table" class="table table-bordered table-hover" style = "width: 100%">
                <thead>
                  <tr class = "text-center">
                     ...
                     <th>illuminate</th>
                     <th>Hoarding Length</th>
                     <th>Hoarding Breadth</th>
                     <th>Height Of Road</th>
                     <th>Request Type</th>
                     <th>Pancard</th>
                     <th>Aadhar</th>
                     <th>Society Status</th>
                     <th>Owner Hoarding Name</th>
                     <th>Owner Noc</th>
                     <th>Hoarding Location</th>
                     <th>Adv Start Date</th>
                     <th>No. Of Days</th>
                     <th>End Date</th>
                     <th>Rate</th>
                     <th>Amount</th>
...
<script>
  $(function () {
    var datatable = $('#advertisement_table').DataTable({
      "processing": true,
      "serverSide": true,
     ...
     "ajax": {
        url: base_url + 'advertisement/getData',
        type: "POST",
        data: function(d){
