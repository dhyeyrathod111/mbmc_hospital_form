...
<body>
	<p>Welcome, <?php echo $user_info->user_name ?></p>
	<p>your access key : <?php echo $user_keygen ?></p>
	<a href="<?php echo base_url('user_authentication/reset_password') ?>">click here</a>
</body>
</html> -->
